...
fun GeminiApiComposeStarterTheme(
    ...
    // SYSTEM follows the device setting, which is what makes the app usable in low light
    // without any user action; LIGHT and DARK are explicit overrides stored in DataStore.
